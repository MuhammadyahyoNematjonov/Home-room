...
const Boglanish = () => {
  const [qoraTema, setQoraTema] = useState(false)
    ...
    <div className={`min-h-screen transition-colors duration-300 ${qoraTema ? "bg-gray-900" : "bg-white"}`}>
      ...
      <button
        ...
        className={`fixed top-20 right-4 z-50 p-3 rounded-full transition-all duration-300 hover:scale-110 ${
          qoraTema ? "bg-white text-gray-900 hover:bg-gray-200" : "bg-gray-800 text-white hover:bg-gray-700"
        }`}
      >
        {qoraTema ? "☀️" : "🌙"}
      </button>
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex items-center space-x-8">
                ...
                <Link to="/Contacts" className="text-gray-300 font-medium">
                  Contacts
                </Link>
              </nav>
            </div>
